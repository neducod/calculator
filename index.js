...
themeToggleBtn.addEventListener('click', () => {
    ...
    if (isLightTheme) {
        ...
        calculatorContainer.classList.add('light-theme');
    } else {
        calculatorContainer.classList.remove('light-theme');
        calculatorContainer.classList.add('dark-theme');
    }
    
    themeToggleBtn.innerText = isLightTheme ? 'Switch to Dark Theme' : 'Switch to Light Theme';
});
